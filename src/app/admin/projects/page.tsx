...
export default function AdminProjects() {
    ...
    const handleCreateProject = async (e: React.FormEvent) => {
        ...
        if (thumbnailFile) {
            ...
            try {
                const uploadRes = await fetch(`https://www.berthonipassoportfolio.com/api/projects/upload-thumbnail`, {
                    method: "POST",
                    headers: {
        ...
        try {
            const endpoint = editingProjectId
                ? `https://www.berthonipassoportfolio.com/api/projects/${editingProjectId}`
                : `https://www.berthonipassoportfolio.com/api/projects/`;
    ...
    const handleDeleteProject = async (id: number) => {
        ...
        try {
            const res = await fetch(`https://www.berthonipassoportfolio.com/api/projects/${id}`, {
                method: "DELETE",
                headers: {
                    "Authorization": `Bearer ${localStorage.getItem("admin_token")}`
                }

...
export default function AdminProjects() {
    ...
    const handleCreateProject = async (e: React.FormEvent) => {
        ...
        if (thumbnailFile) {
            ...
            try {
                const uploadRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL || ""}/api/projects/upload-thumbnail`, {
                    method: "POST",
                    headers: {
        ...
        try {
            const endpoint = editingProjectId
                ? `${process.env.NEXT_PUBLIC_API_URL || ""}/api/projects/${editingProjectId}`

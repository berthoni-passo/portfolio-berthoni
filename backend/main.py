...
from routers import projects, interactions, rag
import os

# Création des tables dans Oracle (à exécuter idéalement via un script de migration type Alembic ou un init simple)
